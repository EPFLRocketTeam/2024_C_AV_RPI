...
int main(void) {
    ...
    std::vector<std::tuple<AvData, AvState>> testData = parseCSV("../tests/old_kalman_tests/Test_AVTrainingData.csv");

    KalmanFilter kalmanFilter = KalmanFilter();

    // Open a new CSV file for writing
    std::ofstream outputFile("../tests/old_kalman_tests/new_output_Kalman_test.csv");
