...
public:
    enum GoatReg {
        ...
        NAV_SENSOR_BMP1_STAT_SENS = 0x09,
        NAV_SENSOR_BMP1_STAT_PWR = 0x09,
        NAV_SENSOR_BMP1_STAT_ERR = 0x09,
        NAV_SENSOR_BMP2_STAT_INTR = 0x0A,
        NAV_SENSOR_BMP2_STAT_SENS = 0x0A,
        NAV_SENSOR_BMP2_STAT_PWR = 0x0A,
        NAV_SENSOR_BMP2_STAT_ERR = 0x0A,

        /* Raw navigation sensors data */
        NAV_SENSOR_ADXL1_DATA_X = 0x0B,
        NAV_SENSOR_ADXL1_DATA_Y = 0x0B,
        NAV_SENSOR_ADXL1_DATA_Z = 0x0B,
        NAV_SENSOR_ADXL2_DATA_X = 0x0C,
        NAV_SENSOR_ADXL2_DATA_Y = 0x0C,
        NAV_SENSOR_ADXL2_DATA_Z = 0x0C,
        NAV_SENSOR_BMI1_ACCEL_DATA_X = 0x0D,
        NAV_SENSOR_BMI1_ACCEL_DATA_Y = 0x0D,
        NAV_SENSOR_BMI1_ACCEL_DATA_Z = 0x0D,
        NAV_SENSOR_BMI1_GYRO_DATA_X = 0x0E,
        NAV_SENSOR_BMI1_GYRO_DATA_Y = 0x0E,
        NAV_SENSOR_BMI1_GYRO_DATA_Z = 0x0E,
        NAV_SENSOR_BMI2_ACCEL_DATA_X = 0x0F,
        NAV_SENSOR_BMI2_ACCEL_DATA_Y = 0x0F,
        NAV_SENSOR_BMI2_ACCEL_DATA_Z = 0x0F,
        NAV_SENSOR_BMI2_GYRO_DATA_X = 0x10,
        NAV_SENSOR_BMI2_GYRO_DATA_Y = 0x10,
        NAV_SENSOR_BMI2_GYRO_DATA_Z = 0x10,
        NAV_SENSOR_BMP1_DATA_TEMP = 0x11,
        NAV_SENSOR_BMP1_DATA_PRES = 0x11,
        NAV_SENSOR_BMP2_DATA_TEMP = 0x12,
        NAV_SENSOR_BMP2_DATA_PRES = 0x12,
